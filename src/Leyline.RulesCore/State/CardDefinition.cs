...
/// applies (only Creature/Spell are ever cast — Champion is a pre-game loadout, never drawn or
...
/// compiling unchanged; Spell cards are the first real users of the Effect* pair — a small,
/// explicitly-scoped placeholder (damage/heal only, see Spells/SpellEffectIds.cs) standing in for
